package me.novoro.helditemsaver.api.configuration;
...
public abstract class VersionedConfig {
     ...
     */
    public void reload() {
        this.reload(HeldItemSaver.inst().getConfig(this.getConfigFileName(), true));
    }
    ...
    protected void reload(Configuration config) {
        ...
        if (this.getCurrentConfigVersion() > configVersion) {
            ...
            HeldItemSaver.inst().saveConfig(this.getConfigFileName(), config);
        }
    }
