...
public final class ColorUtil {
    ...
    public static String toJson(Text text) {
        return Text.Serialization.toJsonString(text, HeldItemSaver.getServer().getRegistryManager());
    }

    public static Text fromJson(String json) {
        return Text.Serialization.fromJson(json, HeldItemSaver.getServer().getRegistryManager());
    }
